...
// function makeOne() {
// 	let numForm = document.forms
// 	paragraph.innerHTML = numForm.length
// }
...
// function makeTwo() {
// 	let findForm = document.forms.formOne
// 	let oneForm = findForm.getAttribute("name");
// 	paragraphTwo.innerHTML = oneForm
// }
...
// function makeThree() {
// 	let fourForm = document.forms.lastForm
// 	paragraphThree.innerHTML = fourForm.getAttribute("name")
// }
...
// 	let oneForm = allForms.formOne;
// 	let twoForm = allForms.formTwo;
// 	let threeForm = allForms.formThree;
// 	let fourForm = allForms.lastForm;

// 	let oneTextName= oneForm.getAttribute("name");
// 	let twoTextName= twoForm.getAttribute("name");
// 	let threeTextName= threeForm.getAttribute("name");
// 	let fourTextName= fourForm.getAttribute("name");

// 	formNames.push(oneTextName, twoTextName,threeTextName,fourTextName);

// 	let stringArray = formNames.join(', ');

// 	paragraphFour.innerHTML = stringArray;
...
// function makeFive() {
// 	let threeForm = document.forms.formThree.elements;
// 	paragraphFive.innerHTML= threeForm.length
// }
...
// function makeSix() {
// 	let twoForm =document.forms.formTwo.elements;
// 	paragraphSix.innerHTML = twoForm.length;
// }
...
// function makeSeven() {
// 	let elementsList='';
// 	let formElements = Array.from(document.forms[1].elements);
...
// function makeNine() {
// 	let elementsList = '';
// 		let formElements = Array.from(document.forms[2].elements);
...
// function makeTen() {
// 	let elementsList = '';
// 		let formElements = Array.from(document.forms[3].elements);

// 		for (let i=0;i<formElements.length;i++) {
// 			elementsList += ` - ${formElements[i].value}`;
// 		}
	
// 		paragraphTen.textContent = elementsList;
// }
...
// function makeEleven() {
// 	let optionsValues = '';
// 	let formElements = document.forms[0].elements[2].options;
...
// function makeTwelve() {
// 	let optionsValues = '';
// 	 Array.from(document.forms[1].elements).forEach((el) => {
// 		if (el.type == 'checkbox') optionsValues += el.id + ', '
// 	});
// 	paragraphTwelve.innerHTML = optionsValues
// }
...
// 	e.preventDefault();
// 	let formElements = Array.from(document.forms[3].elements);
// 	if (formElements[0].checked === true) paragraphThirteen.innerText = 'Кнопка выбрана'; else paragraphThirteen.innerText = 'Кнопка не выбрана';
// }
...
// 	let formElements = document.forms[0].elements[2];
// 	formElements.selectedIndex = 1;
// 	let newValue = formElements.value;

// 	if ( newValue == 'Опция 1') {
// 		paragraphFourteen.innerText = "Выбран первый вариант";
// 	}
// 	else if (newValue == 'Опция 2') {
...
// 	// formElements.checkboxThree.checked = true;
// 	let checks = Array.from(formElements).filter(el => el.type == 'checkbox');
...
// 	let oneInput = formOne.elements.firstName;
// 	let twoInput = formOne.elements.firstEmail;

// 	if (oneInput.value == '' || twoInput.value == '') {
// 		document.querySelector('#errorMessage').textContent = 'Поле не заполнено';
...
// const selectElement = document.forms.formOne;

// selectElement.onchange = function () {
// 	let nameForm = selectElement.elements.firstSelect;
// 	if (nameForm.value == 'Опция 1'){
// 		document.body.style.backgroundColor = 'red'
// 	}
// 	else if (nameForm.value == 'Опция 2') {
...
// 		event.preventDefault();
// 		document.getElementById('result22').textContent = 'Ошибка. Введите имя';
// 	} else {
...
// const selectElement = document.forms.lastForm.elements;
// const choceCheck = selectElement.fourthName;
// const submButton = selectElement.fourthButton;
...
// const nameForm = document.forms[2].elements.thirdName.placeholder


// document.querySelector('.b-26').onclick = function (event) {
// 	event.preventDefault();
// 	document.querySelector('#result26').textContent = nameForm;
// };
...
// const formTwo2 = document.forms.formTwo;
// const resultElement = document.getElementById('result30');

// formTwo2.addEventListener('submit', handleSubmit);

// function handleSubmit(event) {
// 	event.preventDefault();

// 	const checkboxes = formTwo2.querySelectorAll('input[type="checkbox"]:checked');
